...
const SYSTEM =
  ...
  "- 수량(있으면): 숫자+개 (예: 30개)\n\n" +
  "변환 규칙(매우 중요):\n" +
  "- ★ 공통 재질 전파: 문서 어딘가(표 아래 문장·비고)에 재질이 한 번만 적혀 있으면(예: 'O-Ring의 재질은 NBR', '전 품목 FKM') 재질 없는 모든 품목에 채우세요.\n" +
  "- ★ 오링 치수: 내경(ID)·굵기(CS·두께·T) 구분. '내경 710 두께 3.5','ID710-CS3.5','710x3.5' → O-RING 710x3.5(내경x굵기). 오링은 내경x굵기 2치수면 충분.\n" +
  "- ★ P·G·S·AS568 계열(P18,P20,P26,S4,G145 등)은 오링 표준코드 → 코드로 함께 출력. 주문제작/비표준 품목도 빠뜨리지 말 것.\n" +
